  ...
  return (
    <div
      ...
      style={{
        ...
        backdropFilter: "blur(4px)",
        display: "flex",
        // On mobile, anchor to bottom like a bottom sheet
    ...
    >
      <div style={{
        ...
        boxShadow: "0 24px 60px rgba(0,0,0,0.16)",
        // Allow scrolling inside the modal if content overflows on small screens
        ...
        {/* Subject + Section — stack on mobile */}
        <div style={{
          display: "grid",
          ...
          <div>
            <label style={labelStyle}>Subject</label>
            <input
              style={{ ...inputStyle, marginBottom: isMobile ? "0" : "0" }}
              placeholder="e.g. English"
              value={form.subject}
              onChange={e => set("subject", e.target.value)}
            />
...
export default function ClassSelector({ user, onSelectClass, onBack }) {
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <div style={{
            ...
            <Icon name="pencil" size={16} style={{ color: "#EEEDFE" }} />
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <div style={{
            ...
            background: "#F8F7FF", border: "1px solid #E8E6FF",
            borderRadius: "20px",
            // On mobile show only the avatar, not the name
            padding: isMobile ? "4px" : "4px 12px 4px 4px",
          }}>
            <div style={{
              width: "26px", height: "26px", background: "#1A1830", borderRadius: "50%",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "11px", fontWeight: "600", color: "#EEEDFE", flexShrink: 0,
            }}>
              {(user?.name || "T").charAt(0).toUpperCase()}
            </div>
            {!isMobile && (
          ...
          <button onClick={onBack} style={{
            ...
            padding: isMobile ? "7px 9px" : "6px 12px",
            cursor: "pointer",
            display: "flex", alignItems: "center", gap: "5px",
          }}>
            <Icon name="door-exit" size={13} />
      ...
      <div style={{
        maxWidth: "880px", margin: "0 auto",
        padding: isMobile ? "28px 16px 60px" : "44px 24px 60px",
        animation: "fadeUp 0.4s ease both",
      }}>
        {/* Page header */}
        <div style={{
          display: "flex",
          // On mobile: stack heading + button
          flexDirection: isMobile ? "column" : "row",
          ...
          <div>
            <p style={{
              ...
              color: "#8884A8", textTransform: "uppercase", letterSpacing: "0.07em",
            }}>
              Welcome back
            </p>
            <h1 style={{
              fontSize: isMobile ? "22px" : "26px",
              fontWeight: "700", color: "#1A1830", margin: 0, lineHeight: 1.2,
            }}>
              {user?.name?.split(" ")[0] || "Teacher"}'s classes
            </h1>
          </div>
                ...
                >
                  ...
                  <div style={{ padding: isMobile ? "16px" : "20px" }}>
                    ...
                    <h3 style={{
                      ...
                      color: "#1A1830", lineHeight: 1.3, wordBreak: "break-word",
                    }}>
                      {cls.name}
                    </h3>
                    {cls.subject && (
