...
//     justify-content: space-between;
//   }
//   .td-nav-actions { display: flex; align-items: center; gap: 8px; }
//   .td-switch-label { display: inline; }
//   .td-main { max-width: 920px; margin: 0 auto; padding: 24px 20px; }
...
//     .td-banner-count { font-size: 22px !important; }
//     .td-nav { padding: 0 12px; height: 52px; }
//     .td-switch-label { display: none; }
//     .td-main { padding: 16px 12px; }
//   }
// `}</style>
