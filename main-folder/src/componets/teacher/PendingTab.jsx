        ...
        return (
          <div key={sub.id} style={{
            ...
            <div className="sub-card-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
              ...
              {/* Right — score + AI badge */}
              <div className="sub-card-right" style={{ textAlign: 'right', flexShrink: 0 }}>
                <p className="sub-card-right-label" style={{ fontSize: 10, color: '#B0AECB', margin: '0 0 3px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  AI score
                </p>
                {hasAiScore ? (
                  <p style={{ fontSize: 19, fontWeight: 700, color: isHighAI ? '#A32D2D' : '#185FA5', margin: 0, lineHeight: 1 }}>
