  ...
  const handleCreate = async () => {
    ...
    try {
      const data = await apiFetch("/create_assignment.php", {
        method: "POST",
        body: JSON.stringify({ title: form.title, description: form.description, instructions: form.instructions, reference_material: form.referenceMaterial, max_score: form.max_score, due_date: form.due_date, rubric: form.rubric }),
      });
      setCreateOpen(false);
  ...
  const handleEditSave = async () => {
    ...
    try {
      await apiFetch("/update_assignment.php", {
        method: "POST",
        body: JSON.stringify({ id: editTarget.id, title: form.title, description: form.description, instructions: form.instructions, reference_material: form.referenceMaterial, max_score: form.max_score, due_date: form.due_date, rubric: form.rubric }),
      });
      setEditTarget(null);
    ...
    <div>
      ...
      {createOpen && (
        <Sheet onClose={() => setCreateOpen(false)} title="Create New Assignment"
          ...
          <AssignmentForm form={form} setForm={setForm} attachments={attachments} setAttachments={setAttachments} onAttachFile={handleAttachFile} />
        </Sheet>
      )}
