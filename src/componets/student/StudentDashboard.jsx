...
export default function StudentDashboard({ user, onBack }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", minHeight: "100vh", gap: "16px", fontFamily: "system-ui, sans-serif" }}>
      <p style={{ fontSize: "18px", fontWeight: "600", color: "#64748b", textAlign: "center" }}>
        Will be done by Student Dashboard Team
      </p>
      <button
        onClick={onBack}
        style={{ padding: "10px 24px", borderRadius: "10px", border: "none", background: "#f1f5f9", color: "#64748b", fontSize: "14px", fontWeight: "700", cursor: "pointer" }}
      >
        ← Back
      </button>
    </div>
