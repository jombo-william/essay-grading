    ...
    <Sheet
      ...
      footer={
        <div style={{ display: 'flex', gap: '10px' }}>
          {canUnsubmit && (
            <button onClick={() => { if (window.confirm('Unsubmit?')) onUnsubmit(sub); }} style={C.dBtn}>
              ↩ Unsubmit
            </button>
          )}
    ...
    >
      ...
      {sub.final_score !== null ? (() => {
        ...
        <div style={{
          ...
          <p style={{ fontSize: '13px', color: '#b91c1c', margin: '0 0 4px' }}>
            {sub.ai_detection_score}% AI-generated — Automatic score: 0
          </p>
      ...
      {sub.ai_feedback && (
        <div style={{
          ...
          <p style={{ fontSize: '13px', color: '#1e293b', margin: 0, lineHeight: '1.85', whiteSpace: 'pre-wrap' }}>
            {sub.ai_feedback}
          </p>
        </div>
      )}
      ...
      {sub.teacher_feedback && (
        <div style={{
          ...
          <p style={{ fontSize: '13px', color: '#1e293b', margin: 0, lineHeight: '1.85' }}>
            {sub.teacher_feedback}
          </p>
        </div>
      )}
